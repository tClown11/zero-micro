...
import (
	...
	"github.com/tClown11/zero-micro/pkg/util"
...
// Verification: Generate a verification code for the user's mobile phone number
...
func (l *VerificationLogic) Verification(req *types.VerificationRequest) (*types.VerificationResponse, error) {
	...
	return &types.VerificationResponse{Code: code}, nil
}
